...
const T: { tr: Dict; en: Dict } = {
  tr: {
    ...
    faq: {
      ...
      a1: "Evet. Sozy Echo bağımsız ve kendi işini yöneten sanatçılar için kuruldu — label ya da PR ajansı şartı yok.",
  ...
  en: {
    ...
    faq: {
      ...
      a1: "Yes. Sozy Echo was built for independent artists managing their own careers — no label or PR agency required.",
